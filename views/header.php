...
if (!isset($_SESSION['login']) || $_SESSION['login']['estado'] == false) {
  ...
  $totaElementos = count($rutaCompleta);

  //Buscaremos la vistaActual en la listaAcceso
  $vistaActual = $rutaCompleta[$totaElementos]; //produccion
  $listaAcceso = $_SESSION['login']['accesos']; //produccion, tareas, reporte-produccion
