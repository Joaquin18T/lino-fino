...
// $accesosV2 = [
//   "ADM" => [
//     ["modulo"=>"","ruta" => "home", "texto" => "Inicio", "visible"=>true, "icono" => "fa-solid fa-wallet"],   
...
//     ["modulo"=>"usuarios","ruta" => "listar-usuario", "visible"=>true, "texto" => "Usuario", "icono" => "fa-solid fa-wallet"],   
    ...
    case 'login':
      ...
      if ($registro) {
        ...
        if (password_verify($claveIngresada, $claveEncriptada)) {
          ...
          //Los accesos se obtiene desde una consulta
